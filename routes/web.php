...
Route::group(['middleware' => ['auth', 'active']], function() {
	...
	Route::get('/general-report', 'HomeController@generalReport')->name('general-report');
	...
	Route::get('category/children/{id}', 'CategoryController@getChildren')->name('category.children');
	...
	Route::get('products/exportNull', 'ProductController@exportNull');
	Route::get('products/orderExport', 'ProductController@exportLatestOrders');
	...
	Route::get('sales/cahier/{id}', 'SaleController@cashierSales')->name('cashierOrders.get');
	...
	// Route::get('areas/gencode', 'CouponController@generateCode');
	Route::post('areas/deletebyselection', 'AreaController@deleteBySelection');
	...
	Route::get('cashier-log/closeShift', 'CashierLogController@closeShift');
	Route::resource('cashier-log', 'CashierLogController');
	...
	Route::get('cash-register/check-cashier-availability', 'CashRegisterController@checkCashierAvailability')->name('cashRegister.checkCashierAvailability');
	Route::post('cash-register/store', 'CashRegisterController@store')->name('cashRegister.store');
	Route::post('cashierRegister/start', 'CashRegisterController@cashierStart')->name('cashierRegister.start');
	Route::post('cashierRegister/Close', 'CashRegisterController@cashierClose')->name('cashierRegister.close');
	...
	Route::get('appSales/sale_by_csv', 'AppSaleController@saleByCsv');
	Route::get('appSales/product_sale/{id}','AppSaleController@productSaleData');
	Route::get('appSales/lims_sale_search', 'AppSaleController@limsappSalesearch')->name('appSale.search');
	Route::get('appSales/lims_product_search', 'AppSaleController@limsProductSearch')->name('product_sale.search');
	Route::get('appSales/getcustomergroup/{id}', 'AppSaleController@getCustomerGroup')->name('appSale.getcustomergroup');
	Route::get('appSales/getproduct/{id}', 'AppSaleController@getProduct')->name('appSale.getproduct');
	Route::get('appSales/getproduct/{category_id}/{brand_id}', 'AppSaleController@getProductByFilter');
	Route::get('appSales/getfeatured', 'AppSaleController@getFeatured');
	Route::get('appSales/get_gift_card', 'AppSaleController@getGiftCard');
	Route::get('appSales/paypalSuccess', 'AppSaleController@paypalSuccess');
	Route::get('appSales/paypalPaymentSuccess/{id}', 'AppSaleController@paypalPaymentSuccess');
	Route::get('appSales/gen_invoice/{id}', 'AppSaleController@genInvoice')->name('appSale.invoice');
	Route::post('appSales/add_payment', 'AppSaleController@addPayment')->name('appSale.add-payment');
	Route::get('appSales/getpayment/{id}', 'AppSaleController@getPayment')->name('appSale.get-payment');
	Route::post('appSales/updatepayment', 'AppSaleController@updatePayment')->name('appSale.update-payment');
	Route::post('appSales/deletepayment', 'AppSaleController@deletePayment')->name('appSale.delete-payment');
