...
class PurchaseController extends Controller
{
    ...
    public function purchaseData(Request $request)
    {
        ...
        if(empty($request->input('search.value'))) {
            ...
            elseif($warehouse_id != 0)
                ...
                $purchases = Purchase::with('supplier', 'warehouse')->offset($start)
                            ...
                            ->whereDate('created_at', '<=' ,$request->input('ending_date'))
                            ->withCount([
                                'products AS sale_price' => function ($query) {
                                            $query->select(DB::raw("SUM(sale_price) as sale_price"));
                                        }
                                    ])
                            ->limit($limit)
                            ->orderBy($order, $dir)
        ...
        if(!empty($purchases))
        {
            foreach ($purchases as $key=>$purchase)
            {
                ...
                $nestedData['reference_no'] = $purchase->id;
    ...
    public function store(Request $request)
    {
        ...
        $sale_price_mobile = $data['sale_price_mobile'];
        ...
        foreach ($product_id as $i => $id) {
            ...
            $lims_product_data->price = $sale_price[$i];
            $lims_product_data->app_price = $sale_price_mobile[$i];
            ...
            $product_purchase['expired_date'] = $expired_date[$i];
            ...
            $product_purchase['sale_price'] = $sale_price[$i];
            $product_purchase['sale_price_mobile'] = $sale_price_mobile[$i];
            ...
            $p_id = ProductPurchase::create($product_purchase);
        }
        
        if ( isset($data['redirect_to_new']) ){
            return redirect('products/create/?p_id='.$lims_purchase_data->id);
        }
    ...
    public function productPurchaseData($id)
    {
        ...
        foreach ($lims_product_purchase_data as $key => $product_purchase_data) {
            ...
            $product_purchase[3][$key] = $product->price;
            $product_purchase[4][$key] = $product_purchase_data->discount;
            $product_purchase[5][$key] = $product_purchase_data->total;
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        foreach ($product_id as $key => $pro_id) {
            ...
            $lims_product_data->price = $sale_price[$key];
            $lims_product_data->app_price = $sale_price_mobile[$key];
            ...
            $product_purchase['sale_price'] = $sale_price[$key];
            $product_purchase['sale_price_mobile'] = $sale_price_mobile[$key];
