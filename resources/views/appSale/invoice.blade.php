    ...
    <div id="receipt-data">
        ...
        <table class="table-data">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$product_name}}</td>
                    <td style="text-align: center">{{$product_sale_data->qty ? number_format((float)($product_sale_data->total / $product_sale_data->qty), 2, '.', '') : 0}}</td>
...
<script type="text/javascript">
    ...
    function auto_print() {
        window.print()
        window.location.replace("../../appSales");
    }
