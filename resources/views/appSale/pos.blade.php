            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="payment-options" style="text-align: center" >
                        ...
                        <div class="column-5">
                            <button style="background-color: #b33771" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="deposit-btn"><i class="fa fa-university"></i>انهاء الشيفت</button>
                        </div>
