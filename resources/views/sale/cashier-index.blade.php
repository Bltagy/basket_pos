    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">اوردات الكاشير ( {{$cashier->name}} )</h3>
            </div>
            {!! Form::open(['route' => ['cashierOrders.get',$cashier->id], 'method' => 'get']) !!}
            <div class="row mb-3 p-3">
                <div class="col-md-8 offset-md-2 mt-3">
                    <div class="d-flex row">
                        <label class="col-md-6">الفلترة بالتاريخ: &nbsp;</label>
                        <div class="col-md-6">
                            <div class="input-group row text-right">
                                <div class="col-md-6">
                                <label class="">من:</label>
                                <input type="text" name="starting_date" class="form-control date" value="{{$starting_date}}" />
                                </div>
                                <div class="col-md-6">
                                    <label class="">الى:</label>
                                    <input type="text" name="ending_date" class="form-control date" value="{{$ending_date}}" />
                                </div>
                                {{-- <input type="text" class="daterangepicker-field form-control" value="{{$starting_date}} الى {{$ending_date}}" required /> --}}
                ...
                <div class="col-md-2 mt-3">
                    <div class="form-group">
                        <button class="btn btn-primary" id="filter-btn" type="submit">فلترة</button>
                    </div>
                </div>
            </div>
            {!! Form::close() !!}
