...
{{--                    {!! $lims_sale_data->staff_note !!}--}}
        ...
        <table class="table-data">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$product_name}}</td>
                    <td style="text-align: center">{{$product_sale_data->total && $product_sale_data->qty ? number_format((float)($product_sale_data->total / $product_sale_data->qty), 2, '.', '') : ''}}</td>
            ...
            <!-- <tfoot> -->
                <tr>
                    ...
                    <th colspan="3"  style="text-align:left">{{number_format((float)$lims_sale_data->total_price, 2, '.', '')}}</th>
                </tr>
...
{{--                @endif--}}
                ...
                <tr>
                    <th  style="text-align:right">{{trans('file.Shipping Cost')}}</th>
                    <th colspan="3" style="text-align:left">{{number_format((float)$lims_sale_data->shipping_cost, 2, '.', '')}}</th>
                </tr>
                @endif
                <tr>
                    <th  style="text-align:right">{{trans('file.grand total')}}</th>
                    <th colspan="3" style="text-align:left">{{number_format((float)$lims_sale_data->grand_total, 2, '.', '')}}</th>
                </tr>
                <tr>
...
{{--                    @endif--}}
        ...
        <table>
            <tbody>
                ...
                @endforeach
                <tr><td class="centered" colspan="3">شكرا للتسوق معنا للشكاوي والاقتراحات 01062693940</td></tr>
                <tr>
...
{{--                    <br>--}}
        ...
        <!-- <div class="centered" style="margin:30px 0 50px">
            ...
            {{trans('file.Developed By')}} Bltagy</strong></small>
        </div> -->
    </div>
</div>
