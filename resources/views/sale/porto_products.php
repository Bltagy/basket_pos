...
$attr = '';
if (oct_get_country_code() != 'eg'){
	$attr = 'attribute="pa_country" terms="ae" terms_operator="IN"';
}else{
	$attr = 'attribute="pa_country" terms="ae" terms_operator="NOT IN"';
}
$attr = 'attribute="pa_country" terms="ddae" terms_operator="IN"';
$output .= do_shortcode( '[' . esc_html( $shortcode ) . ' columns="' . $columns . '"' . $extra_atts . ' '.$attr.']' );
