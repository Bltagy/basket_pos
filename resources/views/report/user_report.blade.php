@extends('layout.main')
{{--@push('styles')--}}
    <link rel="stylesheet" href="<?php echo asset('css/daterangepicker.css') ?>" type="text/css" id="custom-style">
{{--@endpush--}}
@section('content')
<section class="forms">
...
{{--                                <input type="text" class="daterangepicker-field-custom form-control" value="{{$start_date}} - {{$end_date}}" required dir="ltr" />--}}
                                <strong  class="m-2">من</strong>
                                <input type="text" class="daterangepicker-field-custom form-control" name="start_date" value="{{$start_date}}" dir="ltr" />
                                <strong class="m-2">الى</strong>
                                <input type="text" class="daterangepicker-field-custom form-control" name="end_date" value="{{$end_date}}" dir="ltr" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                @if($unit)
                                    {{$product  ? $product->translate('ar')->name.' ('.$product_sale_data['qty'].' '.$unit->unit_code.')' : ""}}
                                @else
                                    {{$product  ? $product->translate('ar')->name.' ('.$product_sale_data['qty'].')': ""}}
                                @endif
                                <br>
                                @endforeach
                                @endif
