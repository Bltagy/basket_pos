						        ...
						        <tr>
						            ...
						            <td class="report-permissions" colspan="5">
						            	<span>
								            <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	@if(in_array("sales-app-add", $all_permission))
							                    	<input type="checkbox" value="1" id="sales-app-add" name="sales-app-add" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="sales-app-add" name="sales-app-add">
							                    	@endif
								                    <label for="sales-app-add" class="padding05">POS MOBILE APP&nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
						            	<span>
