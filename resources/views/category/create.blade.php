          ...
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <div class="row">
                <div class="col-md-6 form-group">
                    <label>{{trans('file.Arabic Name')}} *</label>
                    {{Form::text('name_ar',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'Type category name...'))}}
                </div>
                <div class="col-md-6 form-group">
                    <label>{{trans('file.English Name')}} *</label>
                    {{Form::text('name_en',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'Type category name...'))}}
                </div>
                <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group">
                    ...
                    {{Form::select('parent_id', $lims_categories, null, ['class' => 'form-control','placeholder' => 'No Parent Category','data-live-search' => 'true'])}}
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).on("click", ".open-EditCategoryDialog", function(){
          ...
          $.get(url, function(data){
            $("#editModal input[name='name_ar']").val(data['name_ar']);
            $("#editModal input[name='name_en']").val(data['name_en']);
