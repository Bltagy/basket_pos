                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="search-box input-group">
                                            ...
                                            <input type="submit" value="كل المنتجات ذات الكمية المتاحة" class="btn btn-primary" id="submit-button-all">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="paper_size" required id="paper-size">
                                            ...
                                            <option value="80">80 mm (HPRT)</option>
                                ...
                                <div class="form-group mt-3">
                                    <input type="submit" value="طباعة" class="btn btn-primary" id="submit-button">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $("#submit-button").on("click", function(event) {
        ...
        if(paper_size != "0") {
            ...
            var htmltext = '<table class="barcodelist" style="width:100%;display:table" cellpadding="5px" cellspacing="10px">';
            ...
            $.each(qty, function(index){
                ...
                while(i < qty[index]) {
                    // if(i % 2 == 0)
                        htmltext +='<tr style="page-break-after: always">';
                    // 36mm
                    if(paper_size == 36)
                        htmltext +='<td style="width:164px;height:88%;padding-top:7px;vertical-align:middle;text-align:center">';
                    //24mm
                    ...
                    //80mm
                        ...
                        htmltext +='<td style="width:100%;height:100%;font-size:20px;font-weight:bold;vertical-align:middle;text-align:center;display:table-cell">';
                    //18mm
                    else if(paper_size == 18)
                        htmltext +='<td style="width:164px;height:100%;font-size:10px;text-align:center">';
                            // htmltext += '<div style="text-align:center;vertical-align: top;font-size:22px;font-weight:bold">{Basket market}</div>';
                    ...
                    if($('input[name="promo_price"]').is(":checked")) {
                        ...
                        htmltext += 'السعر: '+currency[index]+' '+price[index];
    ...
    $("#submit-button-all").on("click", function(event) {
        $("#submit-button-all").attr('disabled','disabled');
        var data1 = false;
        $.ajax({
            type: 'GET',
            url: 'lims_product_search/?all=1',
            data: {
                data: data1
            },
        ...
        $("#submit-button-all").removeAttr('disabled')
    });
