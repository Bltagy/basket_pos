                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_ar" value="{{$lims_product_data->name_ar}}" required class="form-control">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_en" value="{{$lims_product_data->name_en}}" required class="form-control">
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="last_date" class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="last_date" value="" id="ending_date" class="form-control" />
