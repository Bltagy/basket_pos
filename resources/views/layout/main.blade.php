...
<html dir="@if( Config::get('app.locale') == 'ar' || $general_setting->is_rtl){{'rtl'}}@endif">
  ...
  <body onload="myFunction()">
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
              <li><a href="{{url('/')}}"> <i class="dripicons-meter"></i><span>{{ __('file.dashboard') }}</span></a></li>
                <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span>تصدير المنتجات</span><span></a>
              ...
              <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span>{{__('file.products')}}</span><span></a>
                <ul id="product" class="collapse list-unstyled ">
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-cart"></i><span>{{trans('file.Sale')}}</span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  ...
                  @endif
                  <li id="delivery-menu"><a href="{{route('areas.index')}}">قائمة المناطق</a></li>
                </ul>
              </li>
              @endif
            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                <?php
                  ...
                  $add_app_permission = DB::table('permissions')->where('name', 'sales-app-add')->first();
                  $add_permission_active = DB::table('role_has_permissions')->where([
                      ['permission_id', $add_permission->id],
                      ['role_id', $role->id]
                  ])->first();
                  $add_app_permission_active =$add_app_permission ? DB::table('role_has_permissions')->where([
                      ['permission_id', $add_app_permission->id],
                      ['role_id', $role->id]
                  ])->first():false;
                ...
                @endif
                @if($add_app_permission_active)
                <li class="nav-item"><a class="dropdown-item btn-pos btn-sm" href="{{route('appSales.index')}}"><i class="dripicons-shopping-bag"></i><span> Mobile APP</span></a></li>
                @endif
                ...
                <div class="modal-body">
                  <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                    ...
                    ?>
                      ...
                      <input type="hidden" name="start_date" value="{{date('Y-m-d') . ' 00:00:00'}}" />
                      <input type="hidden" name="end_date" value="{{date('Y-m-d') . ' 23:59:00'}}" />
    ...
    <script type="text/javascript" src="<?php echo asset('vendor/jquery/bootstrap-datepicker.ar.min.js') ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo asset('js/onscan.js') ?>"></script>
