                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>{{trans('file.Sale Price Mobile')}}</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="hidden">
                                                            <input type="text" class="form-control expired-date" name="expired_date[]" />
                                                        </td>
                                                        @endif
                                                        <td class="net_unit_cost">
                                                            <input type="text" class="form-control net_unit_cost" name="net_unit_cost[]" value="{{$product_data->cost}}" /></td>
                                                            <td class="sale_price">
                                                                <input type="text" class="form-control sale_price" name="sale_price[]" value="{{$product_purchase->sale_price}}" /></td>
                                                                <td class="sale_price_mobile">
                                                                    <input type="text" class="form-control sale_price_mobile" name="sale_price_mobile[]" value="{{$product_purchase->sale_price_mobile}}" /></td>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(flag){
                ...
                console.log(data);
                cols += '<td class="net_unit_cost"><input type="text" class="form-control net_unit_cost" name="net_unit_cost[]" value="' + data[2] + '"/></td>';
...
function checkPrice(purchase_qty, flag) {
        var row_product_code = $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(2)').text();
        ...
        $('#editModal').modal('hide');
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.net_unit_cost').val(purchase_qty);
        calculateRowProductDataPrice(purchase_qty);
    }

function calculateRowProductDataPrice(net_unit_cost) {
        console.log(net_unit_cost);
        // unitConversion();
